...
## Tasks
### Music Package for Version 0.1.0.a
- [X] Rename MusicList Resource to MusicGeneralController
...
### Test Music Package for Version 0.1.0a
- [ ] Test MusicModel (select, insert, udpate, delete, as_json, query, createTable, checkTable) 
- [ ] Test MusicGeneralController (GET, PUT)
- [ ] Test MusicController  (GET, POST, DELETE)